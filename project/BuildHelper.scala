...
object BuildHelper extends ScalaSettings {
  ...
  def meta = Seq(
    ThisBuild / homepage   := Some(url("https://github.com/changzhiwin/zio-http-mini")),
    ThisBuild / scmInfo    :=
      Some(
        ScmInfo(url("https://github.com/changzhiwin/zio-http-mini"), "scm:git@github.com:changzhiwin/zio-http-mini"),
      ),
